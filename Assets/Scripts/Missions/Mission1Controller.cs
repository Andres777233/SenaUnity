...
namespace Popayork.Missions
{
    ...
    public class Mission1Controller : MonoBehaviour
    {
        ...
        {
            if (config == null || config.waves == null || config.waves.Length == 0 || waveManager == null)
            {
                return;
            }
        ...
        public void Simulate(float dt)
        {
            ...
            WarnIfClose();
            if (waveSpawned && (waveManager == null || !waveManager.IsRunning) && CountPolice() == 0)
            {
        ...
        private void SpawnAllies()
        {
            ...
            for (int e = 0; e < n; e++)
            {
                for (int i = 0; i < config.alliesWave.entries[e].count; i++)
                {
                    ...
                    pool.Spawn(config.alliesWave.entries[e].faction, spot, rally, "aliado_e" + e + "_" + i);
                }
            }
        }
